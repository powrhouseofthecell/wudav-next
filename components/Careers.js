...
const Careers = () => {
   ...
   return (
      <>
         ...
         <p>
            Individuals with love for creativity are welcome. And if you hate your current job and
            wish to do something creative, we have our arms open for you.
         </p>

         <p>
            We would love to work with design enthusiasts, copywriters, social media managers,
            digital marketing experts, content writers, bloggers, influencers, script writers, voice
            over artists, DOPs, photographers.
         </p>
